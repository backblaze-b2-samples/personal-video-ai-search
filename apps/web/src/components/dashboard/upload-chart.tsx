  ...
  return (
    <Card>
      <CardHeader className="border-b border-border py-4 px-5">
        <CardTitle className="card-title">B2 Activity</CardTitle>
        <CardDescription className="text-xs">Objects written, last 7 days</CardDescription>
      ...
      <CardContent className="p-5">
        {error ? (
          ...
          <EmptyState
            ...
            description="Add a video on the Library page to see B2 write activity here."
          />
        ) : (
