      ...
      <div className="animate-fade-in border-b border-border pb-5 flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1.5">
            ...
            per-video pipeline status — transcript, scene tags, faces, and the
            searchable index.
          </p>
        </div>
        <IngestDialog />
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <EmptyState
              icon={Film}
              title="No videos yet"
              description="Add a video to index it (transcript + scene tags + faces) and make it searchable. It's stored entirely in Backblaze B2."
            />
          ) : (
