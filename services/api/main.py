...
app = FastAPI(
    title="Personal Video AI Search API",
    description=(
        "Search and browse a personal video archive by transcript, on-screen "
        "scene tags, and the people in it — backed entirely by Backblaze B2."
    ),
    version="0.1.0",
    lifespan=lifespan,
)
