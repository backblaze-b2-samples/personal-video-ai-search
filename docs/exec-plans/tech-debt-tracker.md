...
| Date/event filters in Search are implemented | Search supports person, `created_at` range, and event-name filters | Keep tests and docs aligned as filter semantics evolve | Low | Resolved |
